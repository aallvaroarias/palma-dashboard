...
export default function Consultor() {
  ...
  const [messages, setMessages] = useState([
    { role: 'bot', text: '¡Hola! Soy el consultor de DISAN 👋 Puedo responder preguntas sobre ventas, cobertura, metas, clientes y SKUs del período actual. ¿En qué te ayudo?' }
  ]);
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <div style={{ color: '#fff', fontWeight: 700, fontSize: '13px' }}>Consultor DISAN</div>
