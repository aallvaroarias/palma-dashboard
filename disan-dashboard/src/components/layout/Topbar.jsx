          ...
          return (
            <Link
              ...
              style={
                isActive
                  ? {
                      background: 'linear-gradient(135deg, rgba(232,148,32,0.22) 0%, rgba(75,168,200,0.1) 100%)',
                      boxShadow: 'inset 0 1px 0 rgba(232,148,32,0.2), 0 0 12px rgba(232,148,32,0.15)',
